...
| file| 주민등록인구통계| [cvs](https://jumin.mois.go.kr/index.jsp) | [시도별/성별](./codes/시도별_총_인구수.ipynb), [구동별](.codes/특정지역_구동별_총_인구수.ipynb) | encoding='cp949' | [행정안전부](https://jumin.mois.go.kr/index.jsp) |  |
